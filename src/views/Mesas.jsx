...
const Mesas = () => {
  ...
  const cargarMesas = async () => {
    ...
    try {
      ...
      setToast({
        mostrar: true,
        mensaje: "Error inesperado al cargar mesas.",
        tipo: "error",
      });
  ...
  const agregarMesa = async () => {
    ...
    try {
      ...
      setToast({
        mostrar: true,
        mensaje: `Mesa "${nuevaMesa.nombre_mesa}" registrada.`,
        tipo: "exito",
      });
    ...
    <Container className="mt-4 pt-3">
      ...
      <Row className="mb-4">
        ...
        <Col className="d-flex gap-2">
          ...
          <Button
            variant={modoVista === "admin" ? "dark" : "outline-dark"}
          ...
          <Button
            variant={modoVista === "pos" ? "success" : "outline-success"}
            onClick={() => setModoVista("pos")}
          >
            <i className="bi bi-grid-1x2-fill me-2"></i>
            POS
          </Button>
